...
{
    return foundation_string_new(((StringObject*)self)->data);
}
...
ClassInitFunction(String)
    ClassMethod(String, ":create", foundation_string_new, 0)
    ClassMethod(String, ":value", foundation_string_value, 0)
    ClassMethod(String, ":length", foundation_string_length, 0)
    ClassMethod(String, ":append:with", foundation_string_append, 1)
    ClassMethod(String, ":copy", foundation_string_copy, 0)
    ClassMethod(String, ":character:at", foundation_string_at, 1)
    ClassMethod(String, ":set:character:at:to", foundation_string_set_at, 2)
    ClassMethod(String, ":destruct", foundation_string_destruct, 0)
